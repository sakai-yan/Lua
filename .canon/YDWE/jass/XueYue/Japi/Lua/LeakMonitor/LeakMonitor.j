...
library LeakMonitor requires XGJAPI
...
function LeakMonitor takes nothing returns nothing
    ...
    call Lua_Exec( "exec-lua:\"XG_JAPI.Lua.LeakMonitor\"" )
    call UnitId("LeakMonitor")
endfunction
...
private function Init takes nothing returns nothing
    call XG_ImportFile("XueYue\\Japi\\Lua\\LeakMonitor\\LeakMonitor.lua","XG_JAPI\\Lua\\LeakMonitor.lua")
endfunction
