...
'      插件基础信息定义
'--------------------------
plugin_name = "JassDebug 崩溃追踪"
' -* 安装说明
plugin_msg_tip = "该插件可以在魔兽崩溃时给出大致的提示" 
...
plugin_zips.Add( vbs_path & "\plugins\JassDebug\JassDebug.zip" )
plugin_zips.Add( war3_path )

' -> 插件是否已安装 检查条件
Function isInstalled()
	isInstalled = fs.FileExists( war3_path & "\JassDebug.asi" )
End Function
