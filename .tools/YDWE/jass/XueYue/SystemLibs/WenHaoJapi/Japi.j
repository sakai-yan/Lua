#ifndef WenHaoJapiIncluded
#define WenHaoJapiIncluded

		#define OPEN

$def WenHao__Japi

library WenHaoJapi //requires WenHaoJapiConstantLib
    ...
    function XG_GetGameVersion takes integer ver returns boolean
		return GetGameVersion() == ver
    endfunction
    //获取插件版本
